...
<?php
    Yii::app()->clientScript->registerScriptFile($this->getStaticAssets() . '/js/test/list.js');
    ...
    $this->widget('ext.bootstrap.widgets.TbGridView', array(
        ...
        'columns' => array(
            ...
            array(
                ...
                'type' => 'raw',
                'htmlOptions' => array(
                    'class' => 'td-last-errors'
                ),
                'value' => function($row){
                    return ($row['status'] == SoapTest::STATUS_TEST_STOP) ? $row['last_errors'] : '---';
                }
            ),
            array(
